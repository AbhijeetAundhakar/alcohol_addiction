...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="apple-touch-icon" href="img/logo1.jpg" sizes="57x57">
        <link rel="apple-touch-icon" href="img/logo1.jpg" sizes="72x72">
        <link rel="apple-touch-icon" href="img/logo1.jpg" sizes="76x76">
        <link rel="apple-touch-icon" href="img/logo1.jpg" sizes="114x114">
        <link rel="apple-touch-icon" href="img/logo1.jpg" sizes="120x120">
        <link rel="apple-touch-icon" href="img/logo1.jpg" sizes="144x144">
        <link rel="apple-touch-icon" href="img/logo1.jpg" sizes="152x152">
        <!-- END Icons -->
        ...
        <div id="page-container"<?php if ($template['page'] == 'full-width') { echo ' class="full-width"'; } ?>>
            ...
            <header class="navbar<?php if ($template['header_navbar']) { echo ' ' . $template['header_navbar']; } ?><?php if ($template['header']) { echo ' '. $template['header']; } ?>">
				...
				include'username.php';
				 ...
				 echo"<a href='emp_profile.php?user=$uname' class='navbar-brand'>" ?>
