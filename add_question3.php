...
<?php 
    include("db.php");
            ...
            $result = mysqli_query($con,"SELECT * FROM questions3  ");
            ...
            <table id="general-table" class="table" border="1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo " <a href ='que_edit3.php?qid=$qid' class='btn btn-sm btn-primary'>Edit</a> &nbsp;";?></td>
