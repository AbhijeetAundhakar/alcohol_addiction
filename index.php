			  ...
			  <div id="page-content" class="block remove-margin">
				  ...
				  <div class="block-header">
					  <div class="header-section">
						  <h1 class="text-center">Welcome to <?php echo $template['name']; ?><br><small>Please Login </small></h1>
					  </div>
					  ...
					  <br>
						  <div class="col-xs-12">
							  <div class="input-group">
								  ...
								  <input type="text" id="uname" name="uname" class="form-control input-lg" placeholder="Username Name" required>
							  </div>
						  </div>
					  </div>
					  <div class="form-group">
